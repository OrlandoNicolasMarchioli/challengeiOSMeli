...
struct AllProductsState{
    ...
    let products: [SelectedProductData]
    let errorMessage: String
    let message: String
    let hasError: Bool
    let noProductsFound: Bool
    
    func clone(productsFetched: [SelectedProductData]? = nil, withErrorMessage: String? = nil, withMessage: String? = nil, withHasError: Bool? = false, withNoProductsFound: Bool? = false) -> AllProductsState{
